        ...
        <div className="w-80 rounded-2xl border border-gray-200 bg-white shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="space-y-4 p-5">
                ...
                <div className="flex gap-3">
                    ...
                    <button className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3 font-medium text-white transition hover:bg-indigo-700" onClick={() => addToCart(product)}>
